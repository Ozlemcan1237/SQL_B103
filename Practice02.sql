...
--Parent tabloda olmayan pk ile child tabloya veri girisi yapilamaz
...
ON DELETE CASCADE --Bu komut yazilinca child silinmeden parent tabloyu silebiliriz
);
...
delete from parent2; --verileri silecegimiz icin delete kullaniyoruz
--child tablodaki veriyi silmeden parent tablodaki veriyi on delete cascade sayesinde silebildik

--SORU2: parent2 tablosunu siliniz
drop table parent2 cascade;
--on delete cascade sayesinde child tablo silinmeden parent tabloyu silinebilecegi icin cascade ekliyoruz
